param(
    ...
    [ValidateSet("all","argocd","demo","istio","longhorn","minio","monitoring","velero")]
...
try {
    ...
    $cmd = "sudo env GATEWAY_NAMESPACE='$gatewayNamespace' GATEWAY_NAME='$gatewayName' LONGHORN_PUBLISH_HOST='$longhornHost' bash /vagrant/deployments/publishing/apply.sh '$Component'"
